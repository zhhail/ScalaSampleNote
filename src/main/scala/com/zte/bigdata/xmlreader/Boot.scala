...
trait XmlBoot {
  ...
  def main(args: Array[String]): Unit = {
    ...
    println(f"total: ${(System.nanoTime-t0)/1000000}%6.3f, count: ${JavaXmlSaxBoot.count}, ${collection.parallel.ForkJoinTasks.defaultForkJoinPool.getParallelism}")
  }
}
...
object JavaXmlStAXBoot_empty extends XmlBoot {
  override def processor(input: Vector[String]): NorthMR_XML_Reader =  new NorthMR_XML_Reader_JavaStAXImpl_empty with NorthMR_XML_Info{}
}
