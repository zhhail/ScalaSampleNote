...
class S99ImplTest extends FlatSpec with ShouldMatchers {
  ...
  it should "test tree" in {
    ...
    node.allNode() shouldBe "(d)(b)(e)(a)(c)(g)(f)"
    node.all_inorder shouldBe "(d)(b)(e)(a)(c)(g)(f)"
    node.all_preorder shouldBe "(a)(b)(d)(e)(c)(f)(g)"
    node.all_postorder shouldBe "(d)(e)(b)(g)(f)(c)(a)"
    node.size() shouldBe 7
    node.isCompleteBalance shouldBe false
    println(node.height())

  }
  ignore should "P46 (**) Truth tables for logical expressions." in {
  ...
  ignore should "P50 (***) Huffman code." in {
  ...
  ignore should "P58 (**) Generate-and-test paradigm." in {
  ...
  ignore should "P59 (**) Construct height-balanced binary trees." in {
  ...
  ignore should "P60 (**) Construct height-balanced binary trees with a given number of nodes." in {
  ...
  ignore should "P61 (*) Count the leaves of a binary tree." in {
  ...
  ignore should "61A (*) Collect the leaves of a binary tree in a list." in {
    Node('a', Node('b'), Node('c', Node('d'), Node('e'))).leafList shouldBe List('b', 'd', 'e')
  }
  ignore should "P62 (*) Collect the internal nodes of a binary tree in a list." in {
    Node('a', Node('b'), Node('c', Node('d'), Node('e'))).internalList shouldBe List('a', 'c')
  }
  ignore should "P62B (*) Collect the nodes at a given level in a list." in {
  ...
  ignore should "P63 (**) Construct a complete binary tree." in {
